System.register(['angular2/core', './mock-content'], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        setters:[
            ...
            function (mock_content_1_1) {
                mock_content_1 = mock_content_1_1;
            }],
        execute: function() {
            HashtagService = (function () {
                ...
                HashtagService.prototype.getContent = function () {
                    return Promise.resolve(mock_content_1.CONTENT);
                };
